...
function page_list_to_pdf($basedir, $pages)
{
	...
	$basename = basename($basedir);
	$pdf_filename = $config['datalab_tmp_dir'] . '/' . $basename  . '.pdf';
	...
	{		
		...
		$file_list_filename =  $config['datalab_tmp_dir'] . '/' . $basename  . '.txt';
...
$identifiers = array(
	...
	//'bulletindumuseu41musea', // doesn't work, why? I think there is a 500 page limit per API call
								// also file size is a factor, reducing 200+ Mb to 70Mb worked
								
	//'australianentom38entob',
	
	//'bonnzoologicalb66zoola',
